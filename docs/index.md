| LSE Data Science Institute | ME204 2025 |
...
---
## ✨ Introduction
1. I collected data from here: https://explore-education-statistics.service.gov.uk/data-catalogue. The UK Department of Education use this site to share Open Datasets (downloadable CSVs) along with explanation guides.
...
<img src="../docs/figures/regions_map.jpg" alt="Description" width="400">
...
<img src="../docs/figures/retention.svg" alt="Description" width="800">

This shape is likely a result of Covid-19, having forced everyone to stay at home and be isolated until mid 2021, the cohort starting that September had more students hoping to re-engage with society and their peers at school, so retention increased. Supported by this figure from a UK Gov Publication, below:
...
<img src="../docs/figures/chars.svg" alt="Description" width="1000">
...
Despite each subplot demonstrating slightly higher percentage of students are top performers (ie. darker colour) on the left side (South), there is a different story about student performance disparities in each. This certainly calls for attention and further analysis should be done to solve these types of, not just regional but, national issues.
...
<img src="../docs/figures/stem.svg" alt="Description" width="900">

In this case we can infer that when A level STEM subjects are being taken or students are studying in an environment where students are being encouraged to take STEM subjects more (even if they don't take them) then a greater proportion of the students return for a second year of study and earn their A level qualifications.
